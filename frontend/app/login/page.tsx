    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-3 sm:px-4 py-8 sm:py-12 pt-20 sm:pt-24">
      <div className="glass max-w-md w-full p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-2xl animate-in fade-in slide-in-from-bottom-5 duration-500">
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-sky-500 to-purple-600 mb-4 shadow-lg shadow-purple-500/50">
            <LogIn className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold gradient-text">
            Welcome Back
          </h1>
          <p className="text-sm text-gray-400 mt-2">Sign in to continue your career journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-sky-500 to-purple-600 text-white py-2.5 sm:py-3 rounded-lg font-semibold hover:scale-[1.02] active:scale-95 transition-all duration-200 disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed shadow-lg shadow-purple-500/50 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            {loading ? (
              <>
